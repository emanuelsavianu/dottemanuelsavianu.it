const CONFIG = {
  ...
  doctors: [
    ...
    },
    {
      ...
      unavailPeriods: [{ from: '2026-08-01', to: '2026-08-31' }],
      monthlyBudget: 152,
    },
    {
      id: 'mqgp5xpe79zho',
    ...
    },
    {
      ...
      preferredPlace: 'Subbiano',
      availability: { lun: { mat: false, pom: true }, mar: { mat: true, pom: false }, mer: { mat: false, pom: true }, gio: { mat: false, pom: true }, ven: { mat: true, pom: false } },
      unavailPeriods: [{ from: '2026-08-13', to: '2026-08-13' }],
      monthlyBudget: 45,
    },
    {
      id: 'mqgp5xpe3wotk',
      ...
      unavailPeriods: [{ from: '2026-08-14', to: '2026-08-14' }, { from: '2026-08-06', to: '2026-08-06' }],
      monthlyBudget: 152,
    },
    {
      id: 'mqgp5xpeohiai',
    ...
    },
    {
      ...
      preferredPlace: 'Subbiano',
      availability: { lun: { mat: true, pom: false }, mar: { mat: false, pom: true }, mer: { mat: true, pom: false }, gio: { mat: true, pom: false }, ven: { mat: false, pom: true } },
      unavailPeriods: [{ from: '2026-08-03', to: '2026-08-03' }, { from: '2026-08-17', to: '2026-08-17' }, { from: '2026-08-21', to: '2026-08-21' }, { from: '2026-08-28', to: '2026-08-28' }],
      monthlyBudget: 152,
    },
    {
      id: 'mrasudwdk87n',
  ...
  assignments: {
    ...
    "2026-08-27_mat_M.S.Savino": "mrasudwdk87n",
    ...
    "2026-08-13_pom_M.S.Savino": "mqgp5xpekiw12"
  },
};
